#ifndef XBEEWEATHERBOARD_WEATHERBOARDCONFIG_H_
#define XBEEWEATHERBOARD_WEATHERBOARDCONFIG_H_
...
const char BMP085_SENSOR_STRING[] PROGMEM = "BMP085";
const char BMP085_SENSOR_INIT[] PROGMEM = "INIT";
...
PGM_P const BMP085_STATUS_MESSAGES[] PROGMEM = {
    BMP085_SENSOR_STRING,        // idx = 0
    BMP085_INIT_SUCCESS,         // idx = 1
    BMP085_INIT_FAILURE,         // idx = 2
    BMP085_ERROR_TEMP_START,     // idx = 3
    BMP085_ERROR_TEMP_GET,       // idx = 4
    BMP085_ERROR_PRESSURE_START, // idx = 5
    BMP085_ERROR_PRESSURE_GET,   // idx = 6
};

/* bmp085_status_messages indices, must match table above */
typedef enum {
  BMP085_SENSOR_STRING_IDX = 0,
  BMP085_INIT_SUCCESS_IDX = 1,
  BMP085_INIT_FAILURE_IDX = 2,
  BMP085_ERROR_TEMP_START_IDX = 3,
  BMP085_ERROR_TEMP_GET_IDX = 4,
  BMP085_ERROR_PRESSURE_START_IDX = 5,
  BMP085_ERROR_PRESSURE_GET_IDX = 6,
...
void weatherboard_sensors_init()
{
  ...
  root[(char*)pgm_read_word(&(SYSTEM_STRINGS[SYSTEM_TOPIC_IDX]))] = (char*)pgm_read_word(&(SYSTEM_STRINGS[SYSTEM_PAYLOAD_IDX]));
  root[(char*)pgm_read_word(&(SYSTEM_STRINGS[SENSOR_TOPIC_IDX]))] = (char*)pgm_read_word(&(BMP085_STATUS_MESSAGES[BMP085_SENSOR_STRING_IDX]));
...
void publish_bmp085_measurements()
{
  ...
  if (status != 0) {
    ...
    status = pressureSensor.getTemperature(
        &bmp085Temp); // temperature returned in degrees Celcius
...
#endif /* XBEEWEATHERBOARD_WEATHERBOARDCONFIG_H_ */
